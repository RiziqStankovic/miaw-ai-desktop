    ...
    <div className={`flex flex-col w-full shrink-0 ${ringClass}`}>
      ...
      <div className="relative window-drag-region" data-window-drag-region>
        <div className="flex items-center w-full px-3 py-2.5 gap-2">
          ...
          <div className="window-no-drag relative flex-1 min-w-0">
          ...
          <motion.button
            ...
            className={`window-no-drag shrink-0 w-9 h-9 rounded-xl flex items-center justify-center transition-colors duration-200 ${
              isBusy
